...
{
    public class AuthenticationAttributeUserIsAdminTest
    {
        [Fact]
        public void OnActionExecuted()
        {
            var actionFiltroAutenticacao = new AuthenticationUserIsAdminAttribute(null, null, null);
        ...
        public void OnActionExecutingInvalidUser()
        {
            ...
            var actionFiltroAutenticacao = new AuthenticationUserIsAdminAttribute(userMock.Object, null, new TokenController(60));
        ...
        public void OnActionExecutingDifferentToken()
        {
            ...
            var actionFiltroAutenticacao = new AuthenticationUserIsAdminAttribute(userMock.Object, tokenMock.Object, new TokenController(60));
        ...
        {
            var actionFiltroAutenticacao = new AuthenticationUserIsAdminAttribute(null, null, new TokenController(0.1)) ;
