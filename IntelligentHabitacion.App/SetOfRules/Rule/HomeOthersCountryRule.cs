...
namespace IntelligentHabitacion.App.SetOfRules.Rule
{
    public class HomeOthersCountryRule : HomeRule, IHomeOthersCountryRule
    {
        ...
        {
            var requestHomeJson = new OthersHomeRegisterStrategy().CreateRequestToRegisterHome(model);
        ...
        {
            var requestHomeJson = new OthersHomeRegisterStrategy().CreateRequestToUpdateHome(model);
