...
{
    public class GetMyTasksCleaningScheduleUseCase : IGetMyTasksCleaningScheduleUseCase
    {
        ...
        public GetMyTasksCleaningScheduleUseCase(ICleaningScheduleReadOnlyRepository repository, ILoggedUser loggedUser,
